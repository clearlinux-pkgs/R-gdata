...
Version  : 2.18.0.1
Release  : 45
URL      : https://cran.r-project.org/src/contrib/gdata_2.18.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gdata_2.18.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652282498
